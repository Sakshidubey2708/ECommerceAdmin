...
public class MyDispatchOrderActivity extends AppCompatActivity {
    ...
    private void initview() {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(MyDispatchOrderActivity.this));
        getNotificationList();
    ...
    private void getNotificationList() {
        try {
            ...
            result = new HelperApi.GETMyOrderPlace().execute(SharedPrefManager.getInstance(MyDispatchOrderActivity.this).getUser().getSubscriberId(),
                    "Dispatch").get();
            if (result.isEmpty()) {
                ...
                MyOrderAdapter viewUserAdapter= new MyOrderAdapter(MyDispatchOrderActivity.this, userModels);
