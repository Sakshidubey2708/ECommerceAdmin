...
public class MyProceedOrderActivity extends AppCompatActivity {
    ...
    private void initview() {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(MyProceedOrderActivity.this));
        getNotificationList();
    ...
    private void getNotificationList() {
        try {
            ...
            result = new HelperApi.GETMyTotalOrder().execute(SharedPrefManager.getInstance(MyProceedOrderActivity.this).getUser().getSubscriberId(),
                    SharedPrefManager.getInstance(MyProceedOrderActivity.this).getUser().getUserID()).get();
            if (result.isEmpty()) {
                ...
                MyOrderAdapter viewUserAdapter= new MyOrderAdapter(MyProceedOrderActivity.this, userModels);
