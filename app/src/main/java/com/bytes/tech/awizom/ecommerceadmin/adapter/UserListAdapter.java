...
import com.bytes.tech.awizom.ecommerceadmin.fragment.UserListFragment;
import com.bytes.tech.awizom.ecommerceadmin.models.UserModel;
...
//            new PostResetPassword().execute(SharedPrefManager.getInstance(mCtx).getUser().UserID,userId);
